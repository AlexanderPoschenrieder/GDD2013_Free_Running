...
namespace Clinica_Frba.Abm_de_Afiliado
{
    public partial class Agregar_Afiliado : Form
    {
        ...
        {
             if (Validar.noVacio(Nombretxt.Text) & Validar.noVacio(Apellidotxt.Text) & Validar.noVacio(NroDoctxt.Text) & Validar.noVacio(TipoDoctxt.Text) & Validar.noVacio(Mailtxt.Text) & Validar.noVacio(Teltxt.Text) & Validar.noVacio(FechaNactxt1.Text) & Validar.noVacio(CantFamHijtxt.Text) & Validar.noVacio(Sexotxt.Text) & Validar.noVacio(EstCiviltxt.Text) & Validar.noVacio(PlanMedtxt.Text) & Validar.IsValidEmail(Mailtxt.Text) & Validar.noVacio(Usertxt.Text) & Validar.noVacio(Clavetxt.Text))
            {
