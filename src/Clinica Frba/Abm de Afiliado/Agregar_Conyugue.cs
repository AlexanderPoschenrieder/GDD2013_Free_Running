...
{
    public partial class Agregar_Conyugue : Form
    {
        long Nro_Afiliado;
        int Cant_Familiares;
        string Estado_Civil;
        ...
        public Agregar_Conyugue(Login.Paciente unPaciente)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Login.Paciente Conyugue = new Login.Paciente(Nro_Afiliado + 1, Nombre, Apellido, Documento, Direccion, Telefono, Mail, Fecha_nac, Sexo, Tipo_documento, Estado_Civil, Cant_Familiares, Plan_medico, Estado, Usuario, clave);
            Conyugue.insertar_usuario();
            Conyugue.insertarAFiliadoConFamilia();
