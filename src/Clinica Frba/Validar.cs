...
namespace Clinica_Frba
{
    class Validar
    {
        ...
        public static bool existeUsuario(string Usuario) 
        {
            ...
            SqlCommand cmd = new SqlCommand("dbo.usuarioExistente" , miconexion);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static bool usuarioIgualExistente(string Usuario, UInt32 id)
        {
            SqlConnection miconexion = Conexion.Conectar();

            SqlCommand cmd = new SqlCommand("dbo.usuarioIgualExistente", miconexion);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Username", Usuario);
        ...
        public static bool noRepiteDocumento(long Identidad,long Documento, string Tipo_documento, string procedimiento) 
        {
            SqlConnection miconexion = Conexion.Conectar();
